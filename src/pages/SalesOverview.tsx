    ...
    >
      ...
      <Reveal>
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
          ...
          <MetricCard icon={BarChart2} label="YTD" value={inr(ytdSales)} rawValue={ytdSales} accent="emerald" sparkline={sparklineValues} dateLabel={`1 Jan – ${formatShortDate(asOfDate)}`} />
      ...
      {/* Sales Summary Card with brand filter */}
      <Reveal delay={100}>
        <SalesSummaryCard
          sales={rangeSales}
      ...
      {/* MTM + WoW — horizontal row before trend */}
      <Reveal delay={105}>
      ...
      {/* Trend Chart with date range picker */}
      <Reveal delay={120}>
      ...
      <Reveal delay={160}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="card p-5">
            <h3 className="font-display text-lg mb-4">Channel Mix — {effectiveRange.label}</h3>
      ...
      <Reveal delay={200}>
        <div className="card p-5">
          <h3 className="font-display text-lg mb-4">Top 10 SKUs — {effectiveRange.label}</h3>
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-[var(--color-muted)] text-xs uppercase">
